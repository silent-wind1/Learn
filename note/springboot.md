...
![1](https://cdn.jsdelivr.net/gh/lengyingmofeng/imgs/imgs/20210718143844.png)
...
![图片](https://cdn.jsdelivr.net/gh/lengyingmofeng/imgs/imgs/20210718131845.webp)
...
SpringBoot将所有的功能场景都抽取出来，做成一个个的starter （启动器），只需要在项目中引入这些starter即可，所有相关的依赖都会导入进来 ， 我们要用什么功能就导入什么样的场景启动器即可 ；我们未来
...
读一下源代码：比如所有的 /webjars/** ， 都需要去 

classpath:/META-INF/resources/webjars/ 找对应的资源；
...
![图片](https://i.loli.net/2021/08/11/vgzE9boNUpqK8Mx.png)
...
![图片](https://i.loli.net/2021/08/11/eQi1uCOXhLqSHIs.png)
...
![图片](https://i.loli.net/2021/08/11/UEJXg9yqOYKdbj1.png)

### 单一应用架构

当网站流量很小时，只需一个应用，将所有功能都部署在一起，以减少部署节点和成本。此时，用于简化增删改查工作量的数据访问框架(ORM)是关键。

![图片](https://i.loli.net/2021/08/11/QU3BHn9TVaIwDl8.png)
...
![图片](https://i.loli.net/2021/08/11/EwmlzdBU9AeNkLu.png)

### 流动计算架构

当服务越来越多，容量的评估，小服务资源的浪费等问题逐渐显现，此时需增加一个调度中心基于访问压力实时管理集群容量，提高集群利用率。此时，用于**提高机器利用率的资源调度和治理中心**(SOA)[ Service Oriented Architecture]是关键。

![图片](https://i.loli.net/2021/08/11/hmgIHWlrSdu3jX2.png)
...
![图片](https://i.loli.net/2021/08/11/aPG8ieW6sOjty9X.png)

**步骤解析：**

![图片](https://i.loli.net/2021/08/11/2Mg7RfGqVNahJEK.png)
...
![图片](https://i.loli.net/2021/08/11/b4x9hjnGqkdYKiR.png)
...
![图片](https://i.loli.net/2021/08/11/8O7EVRtDeIGjwXP.png)
...
![图片](https://i.loli.net/2021/08/11/9GAeRBE5kXYoUq6.png)
...
![图片](https://i.loli.net/2021/08/11/CcvIsqf6izLoE89.png)

安装完成！



## 13. SpringBoot + Dubbo + zookeeper
...
![图片](https://i.loli.net/2021/08/11/abg2rw6PkHRqnxo.png)
